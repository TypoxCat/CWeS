...
struct FloorInfo {
    ...
    FloorInfo();
    FloorInfo(int f, const string& a);
};
...
class Space {
public:
    Space(const string& n, int cap, int floor_num, const string& access_desc);
    ...
    void set_access_desc(const string& a) { floor_details.access_desc = a; }
...
public:
    CoWorkingSpace(const string& code, const string& n, int cap, int floor_num, const string& access_desc);
